...
function twentytwenty_register_styles() {
  ...
  // Custom CSS
  wp_enqueue_style('twentytwenty-sbx-style', get_template_directory_uri() . '/assets/css/style.min.css', 'twentytwenty-style', $theme_version);
 ...
 *
 * This does not enqueue the script because it is tiny and because it is only
 * for IE11, thus it does not warrant having an entire dedicated blocking
 * script being loaded.
 *
...
/**
 * Include a skip to content link at the top of the page so that users can
 * bypass the menu.
 */
...
function twentytwenty_customize_controls_enqueue_scripts() {
  ...
  wp_enqueue_script('twentytwenty-customize', get_template_directory_uri() . '/assets/js/customize.js', ['jquery'], $theme_version, FALSE);

  // Add script for color calculations.
  wp_enqueue_script('twentytwenty-color-calculations', get_template_directory_uri() . '/assets/js/color-calculations.js', ['wp-color-picker'], $theme_version, FALSE);
